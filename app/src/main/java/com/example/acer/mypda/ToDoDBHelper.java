...
public class ToDoDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        System.out.println("ToDo Database Helper onCreate called. ");
    ...
    public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
        ...
        System.out.println("ToDo Database Helper onUpgrade called. ");
    ...
    public void addToDoItem(ToDoItem task) {
        ...
        values.put(KEY_PICTURE, task.getImageByte());
    ...
    public List<ToDoItem> getAllTasks() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                task.setImageByte(cursor.getBlob(2));
